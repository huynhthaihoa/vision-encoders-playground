...
class YOLOv12(BaseEncoder):
    def __init__(self, architecture="yolov12n", 
                pretrained=False, 
                finetune=False, 
                # out_dimList = [],
                replace_silu=False, 
        ...
        super(YOLOv12, self).__init__(finetune)
        ...
        if architecture.find('yolov12n') != -1:
            self.dimList = [64, 128, 256]
        elif architecture.find('yolov12s') != -1:
            self.dimList = [128, 256, 512]
        elif architecture.find('yolov12m') != -1:
            self.dimList = [256, 512, 512]
        elif architecture.find('yolov12l') != -1:
            self.dimList = [256, 512, 512]
        elif architecture.find('yolov12x') != -1:
            self.dimList = [384, 768, 768]
        ...
        if pretrained:
            ...
            ckpt_path = f"https://github.com/sunsmarterjie/yolov12/releases/download/v1.0/{architecture}.pt"
