...
from timm.models.registry import register_model#, create_model
...
default_cfgs = {
    'fastervit_0_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_0_224_1k.pth.tar',
                             crop_pct=0.875,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_1_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_1_224_1k.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_2_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_2_224_1k.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_3_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_3_224_1k.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_4_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_4_224_1k.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_5_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_5_224_1k.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_6_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_6_224_1k.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 224, 224),
                             crop_mode='center'),
    'fastervit_4_21k_224': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_4_21k_224_w14.pth.tar',
                             crop_pct=0.95,
                             input_size=(3, 224, 224),
                             crop_mode='squash'),                          
    'fastervit_4_21k_384': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_4_21k_384_w24.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 384, 384),
                             crop_mode='squash'),
    'fastervit_4_21k_512': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_4_21k_512_w32.pth.tar',
                             crop_pct=1.0,
                             input_size=(3, 512, 512),
                             crop_mode='squash'),
    'fastervit_4_21k_768': _cfg(url='https://huggingface.co/ahatamiz/FasterViT/resolve/main/fastervit_4_21k_768_w48.pth.tar',
                             crop_pct=0.93,
...
class FasterViT(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(len(depths)):
            ...
            self.dimList.append(int(dim * 2 ** i))
...
#@register_pip_model
@register_model
def fastervit_0_224(pretrained=False, **kwargs):
    ...
    model_path = kwargs.pop("model_path", "/tmp/fastervit_0.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_0_224').to_dict()
...
#@register_pip_model
@register_model
def fastervit_1_224(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", 224)
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    model_path = kwargs.pop("model_path", "/tmp/fastervit_1.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_1_224').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_2_224(pretrained=False, **kwargs):
    ...
    resolution = kwargs.pop("resolution", 224)
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    model_path = kwargs.pop("model_path", "/tmp/fastervit_2.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_2_224').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_3_224(pretrained=False, **kwargs):
    ...
    model_path = kwargs.pop("model_path", "/tmp/fastervit_3.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_3_224').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_4_224(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [3, 3, 12, 5])
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    model_path = kwargs.pop("model_path", "/tmp/fastervit_4.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_4_224').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_5_224(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [3, 3, 12, 5])
    num_heads = kwargs.pop("num_heads", [4, 8, 16, 32])
    window_size = kwargs.pop("window_size", [7, 7, 7, 7])
    ct_size = kwargs.pop("ct_size", 2)
    ...
    drop_path_rate = kwargs.pop("drop_path_rate", 0.3)
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    model_path = kwargs.pop("model_path", "/tmp/fastervit_5.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_5_224').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_6_224(pretrained=False, **kwargs):
    ...
    layer_scale = kwargs.pop("layer_scale", 1e-5)
    model_path = kwargs.pop("model_path", "/tmp/fastervit_6.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_6_224').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_4_21k_224(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [3, 3, 12, 5])
    num_heads = kwargs.pop("num_heads", [4, 8, 16, 32])
    ...
    pretrained_cfg = resolve_pretrained_cfg('fastervit_4_21k_224',).to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_4_21k_384(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [3, 3, 12, 5])
    num_heads = kwargs.pop("num_heads", [4, 8, 16, 32])
    ...
    hat = kwargs.pop("hat", [False, False, False, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_4_21k_384').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_4_21k_512(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [3, 3, 12, 5])
    num_heads = kwargs.pop("num_heads", [4, 8, 16, 32])
    ...
    hat = kwargs.pop("hat", [False, False, False, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_4_21k_512').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
...
#@register_pip_model
@register_model
def fastervit_4_21k_768(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [3, 3, 12, 5])
    num_heads = kwargs.pop("num_heads", [4, 8, 16, 32])
    ...
    hat = kwargs.pop("hat", [False, False, False, False])
    pretrained_cfg = resolve_pretrained_cfg('fastervit_4_21k_768').to_dict()
    _update_default_kwargs(pretrained_cfg, kwargs, kwargs_filter=None)
    model = FasterViT(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
